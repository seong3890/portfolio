...
//                em.persist(post);
           ...
           /* Member member = new Member();
            member.setUsername("kane");
            member.setNickname("kane123");
            member.setPassword("asdasd12#");
            em.persist(member);
            Book book = createBook("jpa책", "김태진", 10000);
            em.persist(book);
            Book book2 = createBook("jpa책2", "김태순", 20000);
            em.persist(book2);
        ...
        private Book createBook(String name, String writer, int price) {
            Book book = new Book();
            book.setName(name);
